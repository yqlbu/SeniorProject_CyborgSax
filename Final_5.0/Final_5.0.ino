...
#define E1_outputA 38//34
#define E1_outputB 37// 36
#define E1_SW 39//35
...
//#define E1_SW 25
//
//#define E2_outputA 34
//#define E2_outputB 36
//#define E2_SW 35
...
// defining parameters here
int FX_val, Color_scheme_val, Lighting_mode_val, Master_volume_val = 10, Dry_wet_val;
float Gain_val = 1.00;
...
Bounce bouncer_1 = Bounce (E1_outputA , 5); //Initiate a Bounce object with a 2 milisecond debounce time
Bounce bouncer_2 = Bounce (E2_outputA , 5); //Initiate a Bounce object with a 2 milisecond debounce time
...
float n, m, w, a, b, c, d, e, f, g, h, i, j, k, l, o, p, qq, r, s, t, u, v, x, y, mm, nn, ww, z, aa, ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al, am, an, ao, ap, aq, ar, as, at, au, av, aw, ax, ay, az, ba, bb, bc, bd, be, bf;
...
void soundOptions(int param1, int param2) {
  if (param1 == 0){
    ...
    amp2.gain(Master_volume_val/10);
...
//    tft.println('F');
    ...
    // bar feature
    bar_rect(f2_paramater_x + 50,f2_paramater_y,100,15,ILI9341_WHITE);
    tft.fillRect(f2_paramater_x + 52, f2_paramater_y, 0, 15, ILI9341_WHITE);
...
{   
    ...
    if (button_state != last_button_state){
        ...
        if(digitalRead(PIN_SWITCH_1) == LOW && digitalRead(PIN_SWITCH_2) == HIGH && digitalRead(PIN_SWITCH_3) == HIGH){
            ...
            // bar feature
            bar_rect(f2_paramater_x + 50,f2_paramater_y,100,15,ILI9341_WHITE);
            tft.fillRect(f2_paramater_x + 52, f2_paramater_y, Dry_wet_val, 15, ILI9341_WHITE);
...
{  
    ...
    if (button_state != last_button_state){
      ...
      if(digitalRead(PIN_SWITCH_3) == LOW){
          ...
          // bar feature
          bar_rect(f2_paramater_x + 55,f2_paramater_y,100,15,ILI9341_WHITE);
          tft.fillRect(f2_paramater_x + 57, f2_paramater_y, Gain_val*20, 15, ILI9341_WHITE);
...
void mode_3()
{
    ...
    if (button_state != last_button_state){
      ...
      if(digitalRead(PIN_SWITCH_1) == HIGH && digitalRead(PIN_SWITCH_2) == LOW && digitalRead(PIN_SWITCH_3) == HIGH){
          ...
          tft.print("%"); // default text
          bar_rect(f2_paramater_x + 50,f2_paramater_y,100,15,ILI9341_WHITE);
          tft.fillRect(f2_paramater_x + 52, f2_paramater_y, Master_volume_val, 15, ILI9341_WHITE);
...
// **************** Gain **************** //
      ...
      Gain_val = constrain(Gain_val,1,5); // 0-5
...
// **************** Master_volume **************** //
      ...
      Master_volume_val = constrain(Master_volume_val,0,100); // 1-100
